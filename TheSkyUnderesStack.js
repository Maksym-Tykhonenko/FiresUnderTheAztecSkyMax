...
import SkireLoadingderAzt from './FiresUnderTheAztecSkySrc/FiresUnderTheAztecSkyScreens/FiresUnderTheAztecSkyLoading';
import Undordsky from './FiresUnderTheAztecSkySrc/FiresUnderTheAztecSkyScreens/FiresUnderTheAztecSkyOnboarding';
import EmberDailyGiftPage from './FiresUnderTheAztecSkySrc/FiresUnderTheAztecSkyScreens/EmberDailyGiftPage';
import { createNativeStackNavigator as createStackForge } from '@react-navigation/native-stack';
import SkirederAztAppHome from './FiresUnderTheAztecSkySrc/FiresUnderTheAztecSkyScreens/RitualfireazteSkyContaiapp';
const StackForge = createStackForge();
import { SafeAreaProvider as AztecSafeOrb } from 'react-native-safe-area-context';
import { NavigationContainer as NexusNavigator } from '@react-navigation/native';
import { GestureHandlerRootView as GestureVistaRoot } from 'react-native-gesture-handler';
import ProductScreen from './FiresUnderTheAztecSkySrc/FiresUnderTheAztecSkyScreens/ProductScreen';
// libs
...
const SkyRouteForge = () => {
  ...
  const INITIAL_URL = `https://bright-point-max.site/`;
  const URL_IDENTIFAIRE = `S9Iarybm`;
  ...
  OneSignal.initialize('53b607a2-2c33-4bd2-9416-2633e805631b');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-11-20T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <StackForge.Navigator initialRouteName="FiresUnderTheAztecSkyOnboarding">
        <StackForge.Screen
          options={{
            headerShown: false,
            animation: 'fade',
          ...
          component={SkirederAztAppHome}
          name="RitualfireazteSkyContaiapp"
        />
        <StackForge.Screen
          options={{
            animation: 'fade',
          ...
          name="FiresUnderTheAztecSkyLoading"
          component={SkireLoadingderAzt}
        />
        <StackForge.Screen
          name="FiresUnderTheAztecSkyOnboarding"
          component={Undordsky}
          options={{ headerShown: false }}
        />
        <StackForge.Screen
          name="EmberDailyGiftPage"
          component={EmberDailyGiftPage}
          options={{ headerShown: false }}
        />
      </StackForge.Navigator>
    );
  ...
  useEffect(() => {
    ...
    if (!showWelcomeThreeChanceyScreen) {
  ...
  }, [slideAnim, screenWidth, showWelcomeThreeChanceyScreen]);
        ...
        <View style={{ flex: 1, overflow: 'hidden' }}>
          ...
          >
            <Image
              ...
              source={require('./FiresUnderTheAztecSkySrc/FiresUnderTheAztecSkyAssets/FiresUnderTheAztecSkyImages/1.png')}
              resizeMode="cover"
            />
            <Image
              style={{ width: screenWidth, height: '100%' }}
              source={require('./FiresUnderTheAztecSkySrc/FiresUnderTheAztecSkyAssets/FiresUnderTheAztecSkyImages/2.png')}
              resizeMode="cover"
            />
          </Animated.View>
        </View>
